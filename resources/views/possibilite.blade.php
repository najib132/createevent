...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-left: 10px;">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link" href="{{ route('congres') }}" style="color: black;"><i
                    class="fa-solid fa-house-user"></i> Accueil <span class="sr-only">(current)</span></a>
            <a class="nav-item nav-link" href="#" style="color: black;"><i class="fa-solid fa-right-from-bracket"></i>
                Déconnexion </a>
        </div>
    </div>
</nav>
                        ...
                        <div class="col-md-8">
                            <div class="d-flex flex-row justify-content-between align-items-center border-bottom pb-1">
                                <h3 class="text-secondary">
                                    <i class="fas fa-calculator"></i> Possibilité
                                </h3>
                            ...
                            <div class="forms" style="width: 102%;">
                                <h3 style="font-size: 24px;">Modif / Suppression Possibilité</h3>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($possibilites as $possibiliteItem)
                                            <tr>
                                                <td style="font-size: 15px;font-family: sans-serif;font-weight: 500;">
                                                    {{ $possibiliteItem->pack->num }}
                                                </td>
                                                <td style="font-size: 15px;font-family: sans-serif;font-weight: 500;">
                                                ...
                                                @if ($possibiliteItem->hotel)
                                                    <td
                                                        style="font-size: 15px;font-family: sans-serif;font-weight: 500;">
                                                ...
                                                <td style="font-size: 15px;font-family: sans-serif;font-weight: 500;">
                                                    {{ $possibiliteItem->plafond }}
                                                </td>
                                                <td style="font-size: 15px;font-family: sans-serif;font-weight: 500;">
                                                    {{ $possibiliteItem->mantant }}
                                                </td>
                                                <td><button class="btn btn-success"><i class="fa fa-pencil-square-o"
                                                            aria-hidden="true"></i> Modifier</button></td>
                                                <td><button class="btn btn-danger"><i class="fa fa-trash"
                                                            aria-hidden="true"></i> Suprimer</button></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <form method="post" action="{{ url('store-possibilite') }}" class="forms" style="min-height: 20px;
    ">
                                @csrf
                                ...
                                <div class="form-group" style="margin-bottom: 15px;">
                                    ...
                                    <select class="form-control" name="pack_id" id="exampleFormControlSelect1">
                                        @foreach ($pack as $packItem)
                                            <option value="{{ $packItem->id }}">{{ $packItem->num }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group" style="margin-bottom: 15px;">
                                    ...
                                    <select class="form-control" name="hotel_id" id="exampleFormControlSelect1">
                                        ...
                                        @foreach ($hotel as $hotelItem)
                                            <option value="{{ $hotelItem->id }}">{{ $hotelItem->hotel_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group" style="margin-bottom: 15px;">
                                    ...
                                    <input type="text" name="plafond" class="form-control" id="plafond">
                                </div>

                                <div class="form-group" style="margin-bottom: 15px;">
                                    <label for="montant">montant (MAD)</label>
                                    <input type="text" name="mantant" class="form-control" id="montant">
                                </div>



                                <button type="submit" class="btn btn-info"><i class="fa fa-plus"></i>
                                    Ajout-Possibilité</button>
                            </form>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Modif / Suppression Possibilité</h2>
                                </div>
                                <div class="col-sm-4">
                                    <a href="#addEmployeeModal" class="btn btn" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Possibilité</span></a>						
                                </div>
                            </div>
                        </div>
            ...
            <div id="addEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                    ...
                    <div class="form-group" style="margin-bottom: 15px;">
                      ...
                      <div class="form-group" style="margin-bottom: 15px;">
                        ...
                        <select class="form-control" name="hotel_id" id="exampleFormControlSelect1">
                            <option value=""></option>
                            @foreach ($hotel as $hotelItem)
                          <option value="{{$hotelItem->id}}">{{$hotelItem->hotel_name}}</option>
                          @endforeach
                        </select>
                      </div>
                    ...
                    <button type="submit" class="btn btn-info" ><i class="fa fa-plus"></i> Ajout-Possibilité</button>
                    </form>
                    </div>
                </div>
            </div>
