                 ...
                 <div class="table-responsive">
                     <div class="table-wrapper">
                         <div class="table-title">
                             <div class="row">
                                 <div class="col-sm-6">
                                     <h2>Modif / Suppression sponsoring</h2>
                                 </div>
                                 <div class="col-sm-4">
                                     <a href="#addEmployeeModal" class="btn btn" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Sponsoring</span></a>						
                                 </div>
                             </div>
                         </div>
                         <table class="table table-striped table-hover">
                             ...
                             <tbody>
                                @foreach ($sponsor as $sponsorItem)
                                 <tr>
 
                                    <td>
                                        {{$sponsorItem->sponsoring}}
                                    </td>
                                    <td>
                                        {{$sponsorItem->designation}}
                                    </td>
                                    <td>
                                        {{$sponsorItem->prix}}
                                    </td>
             ...
             <div id="addEmployeeModal" class="modal fade">
                 <div class="modal-dialog">
                     <div class="modal-content">
                        ...
                        <form method="post" action="{{ url('store-sponsor') }}" class="forms" style="min-height: 20px;">
                    @csrf
                    ...
                    <input type="text" name="sponsoring" class="form-control" id="sponsoring" >
