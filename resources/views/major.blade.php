                     ...
                     <div class="table-wrapper">
                         <div class="table-title">
                             <div class="row">
                                 ...
                                 <div class="col-sm-4">
                                     <a href="#addEmployeeModal" class="btn btn" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Majoration</span></a>						
                                 </div>
                             </div>
                         </div>
                         <table class="table table-striped table-hover">
                             <thead>
                                ...
                                <tbody>
                                    @foreach ($major as $majorItem)
                                        
                                    
                                <tr>
                                    <td>
                                        {{$majorItem->pourcentage}}
                                    </td>
                                    <td></td>
             ...
             <div id="addEmployeeModal" class="modal fade">
                 <div class="modal-dialog">
                     <div class="modal-content">
                            ...
                            <form method="post" action="{{ url('store-major') }}" class="forms"style="min-height: 20px;">
                                @csrf
                                ...
                                <div class="form-group" style="margin-bottom: 15px;">
                                <label for="contenu">pourcentage</label>
                                <input type="text" name="pourcentage" class="form-control" id="pourcentage" >
