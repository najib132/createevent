                     ...
                     <div class="table-wrapper">
                         <div class="table-title">
                             <div class="row">
                                 ...
                                 <div class="col-sm-4">
                                     <a href="#addEmployeeModal" class="btn btn" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Hotel</span></a>						
                                 </div>
                             </div>
                         </div>
             ...
             <div id="addEmployeeModal" class="modal fade">
                 <div class="modal-dialog">
                     <div class="modal-content">
                        ...
                        <form method="post" action="{{url('store-hotel')}}" class="forms" style="min-height: 20px;">
@csrf
...
<div class="form-group" style="margin-bottom: 15px;">
<label for="contenu">Hotels_nom</label>
<input type="text" name="hotel_name" class="form-control" id="hotel" >
...
<div class="form-group" style="margin-bottom: 15px;">
    ...
    <select class="form-control" name="category" id="exampleFormControlSelect1">
      <option value="5_etoil">5 étoile</option>
      <option value="4_etoile">4 étoile</option>
      <option value="3_etoile">3 étoile</option>
    </select>
  </div>

<button type="submit" class="btn btn-info" ><i class="fa fa-plus"></i> Ajout-hotel</button>
</form>
                     </div>
                 </div>
             </div>
