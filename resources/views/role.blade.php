                     ...
                     <div class="table-wrapper">
                         <div class="table-title">
                             <div class="row">
                                 ...
                                 <div class="col-sm-4">
                                     <a href="#addEmployeeModal" class="btn btn-info" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Role</span></a>						
                                 </div>
                             </div>
                         </div>
             ...
             <div id="addEmployeeModal" class="modal fade">
                 <div class="modal-dialog">
                     <div class="modal-content">
                         ...
                         <form method="post" action="{{ url('store-role') }}" class="forms" style="min-height: 20px;">
@csrf
                     ...
                     <div class="modal-content">
                         <form>
                             ...
                             <div class="modal-footer">
                                 ...
                                 <form action="{{-- {{route('delete_role', $roleItem->id)}} --}}" method="post">
                                     @csrf
                                     @method('delete')
